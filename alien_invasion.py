...
class AlienInvasion:
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= self.settings.screen_height:
                #gleiche reaction wie bei einer kollision mit dem schiff
                self._ship_hit()
                break
    ...
    def _update_screen(self):
        ...
        #zeichnet den Play-Button nur bei inaktivem Spiel
